...
class ViTEncoder(nn.Module):
    def __init__(self, image_size=[256, 256, 128], patch_size=16, dim=512,
                 depth=8, heads=8, mlp_dim=4, channels=1, dim_head=64,
        ...
        self.to_patch_embedding = nn.Sequential(
            Rearrange("b c (h p1) (w p2) (t p3) -> b (h w t) (p1 p2 p3 c)",
...
class Vit3D(nn.Module):
    def __init__(self, input_size=[256, 256, 128], patch_size=32, dim=512, depth=8):
        super().__init__()
